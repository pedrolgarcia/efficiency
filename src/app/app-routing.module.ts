...
const routes: Routes = [
  ...
  { path: '' , canActivate: [AuthGuard], canActivateChild: [AuthGuard],
    children: [
      ...
      { path: 'time-report/:id', loadChildren: './reports/time-report/time-report.module#TimeReportPageModule' },
      { path: 'error-report/:id', loadChildren: './reports/error-report/error-report.module#ErrorReportPageModule' },
